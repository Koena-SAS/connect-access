...
from ..choices import MediationRequestStatus
...
def test_mediation_requests_list_contains_all_mediation_requests(authenticate):
...
def test_mediation_request_delete(authenticate):
...
def test_mediation_request_retrieve(authenticate):
    mediation_request = MediationRequestFactory()
    detail_url = _get_mediation_request_absolute_url("detail", mediation_request.uuid)
...
def test_mediation_request_update(request_data_for_mediation_request, authenticate):
