...
class TestSerializers:
    def test_mediation_request_serializes_correctly_all_fields(self, authenticate):
        ...
        assert (
            data["mobile_app_used"] == "YES"
            if mediation_request.mobile_app_used
            else "NO"
        )
        assertContains(
    ...
    def test_mediation_request_deserializes_correctly_all_fields(
        ...
        assert (
            MediationRequestStatus(mediation_request.status).name
        ...
        assert (
            mediation_request.organization_address
            == request_data["organization_address"]
        )
