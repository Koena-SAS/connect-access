...
from connect_access.apps.configuration.tests.utils import (
...
class TestSerializers:
    def test_contact_information_serializes_correctly_all_fields(self):
        ...
        assertContains(response, contact_information.terms_of_service_fr)
        assertContains(response, contact_information.terms_of_service_en)

    def test_about_services_serializes_correctly_all_fields(self):
