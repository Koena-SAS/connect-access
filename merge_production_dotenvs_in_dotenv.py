...
PRODUCTION_DOTENV_FILE_PATHS = [
    ...
    PRODUCTION_DOTENVS_DIR_PATH / ".traefik",
    PRODUCTION_DOTENVS_DIR_PATH / ".docker",
    PRODUCTION_DOTENVS_DIR_PATH / ".data",
]
PRODUCTION_DOTENV_FILE_PATH = ROOT_DIR_PATH / ".env_production"

STAGING_DOTENVS_DIR_PATH = ROOT_DIR_PATH / ".envs" / ".staging"
STAGING_DOTENV_FILE_PATHS = [
    STAGING_DOTENVS_DIR_PATH / ".django",
    STAGING_DOTENVS_DIR_PATH / ".postgres",
    STAGING_DOTENVS_DIR_PATH / ".traefik",
    STAGING_DOTENVS_DIR_PATH / ".docker",
    STAGING_DOTENVS_DIR_PATH / ".data",
]
STAGING_DOTENV_FILE_PATH = ROOT_DIR_PATH / ".env_staging"
...
def main():
    merge(PRODUCTION_DOTENV_FILE_PATH, PRODUCTION_DOTENV_FILE_PATHS)
    merge(STAGING_DOTENV_FILE_PATH, STAGING_DOTENV_FILE_PATHS)
