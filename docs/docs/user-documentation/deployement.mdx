...
The name of the main logo in `frontend/src/images/`, with a recommended size of 178 x 80 pixels. If it is your own image, you have to add it there. You can let the default value for this environment variable and add your image in `frontend/src/images/`.
...
This will create the two files `.env_production` and `.env_staging` that are simply the concatenation of the 5 separate fiels you configured.
