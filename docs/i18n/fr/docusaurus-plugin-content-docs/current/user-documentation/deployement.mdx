...
Ici vous pouvez ajouter des informations à propos de votre entreprise ou organisation. Ces informations apparaîtront dans le pied de page de l'application <span lang="en">Connect Access</span> dans la section "Nous contacter".
